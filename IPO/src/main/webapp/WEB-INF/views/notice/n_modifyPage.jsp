						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">작성자</label> <input type="text"
									name="writer" class="form-control" value="${noticeVO.writer}" readonly="readonly">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea id="contents" class="form-control" name="content" rows="15">${noticeVO.content}</textarea>
							</div>
							<div class="form-group">
...
<script>
	$(document).ready(function(){
		...
		$(".btn-warning").on("click", function(){
		  self.location = "${location}/notice/list?page=${cri.page}&perPageNum=${cri.perPageNum}"+
	...
	var template = Handlebars.compile($("#template").html());
	$.getJSON("${location}/notice/getAttach/"+bno,function(list){
		$(list).each(function(){
...
$(document).ready(function() {
	$("#modifySuccess").click(function() {
		...
		document.form1.action = "${location}/notice/n_modifyPage"
		// 제출
