...
<body>
	...
	<div class="container" style="margin-top: 50px">
		<div class="box-header">
			<h3 class="box-title">안정추구형 리스트</h3>
		</div>
		...
		<div class="text-center">
			<ul class="pagination pagination-lg" style="margin-right: 80px;">
				...
				<c:if test="${pageMaker.prev}">
					<li><a
						href="safetyPreList${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
				</c:if>
				...
				<c:forEach begin="${pageMaker.startPage }"
					...
					<li
						...
						<a href="safetyPreList${pageMaker.makeSearch(idx)}">${idx}</a>
					</li>
				</c:forEach>

				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li><a
						href="safetyPreList${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
				</c:if>
