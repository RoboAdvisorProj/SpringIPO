		...
		<div class="text-center">
			<ul class="pagination pagination-lg" style="margin-right: 80px;">
				...
				<c:if test="${pageMaker.prev}">
					<li><a
						href="riskAvoidList${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
				</c:if>
				...
				<c:forEach begin="${pageMaker.startPage }"
					...
					<li
						...
						<a href="riskAvoidList${pageMaker.makeSearch(idx)}">${idx}</a>
					</li>
				</c:forEach>

				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li><a
						href="riskAvoidList${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
				</c:if>
