...
<div id="content">
		...
		<form method="post" id="join_form" name="join_form" action="">
			...
			<div class="article">
				...
				<div class="agree">
					DOIPO 서비스 이용약관 동의<span class="important">(필수)</span>
				</div>
...
이 약관은 DOIPO ("회사" 또는 "DOIPO")가 제공하는 DOIPO 및 DOIPO 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
	
제 2 조 (정의)

이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 DOIPO 및 DOIPO 관련 제반 서비스를 의미합니다.
...
- 게시중단요청서비스 : http://help.DOIPO.com/claim_main.asp
...
③해외에 주소나 거소가 있는 '회원' 의 경우 '회사'와 '회원'간 발생한 분쟁에 관한 소송은 전항에도 불구하고 대한민국 서울중앙지방법원을 관할 법원으로 합니다.</textarea>
			</div>
			
			<div class="article">
				<i class="fa fa-check-circle-o" id="second-check" aria-hidden="true"></i>
				<div class="agree">
					DOIPO 개인정보 수집및 이용동의<span class="important">(필수)</span>
				</div>
				<textarea class="form-control" rows="20" cols="110" readonly="readonly">
개인정보 수집 및 이용

1. 개인정보의 수집
(주)DOIPO코리아(이하 '회사')는 게임 서비스 운영을 위해 아래와 같이 이용자의 개인정보를 수집하고 있습니다.
1) 온라인 서비스
① 인터넷 회원제 서비스 이용에 따른 이용자 식별, 중복가입 여부 확인
- (필수)ID, 닉네임, 비밀번호
② 고지사항 안내 등 원활한 의사소통 경로 확보
- (필수)법정대리인의 이메일주소
- (선택)휴대폰번호, 이메일주소
③ 본인확인기관을 통한 본인인증
- (필수)이름, 생년월일, 성별, 내외국인정보, 이동통신사정보, 휴대폰번호, 연계정보(CI), 중복가입정보(DI)
④ 법정대리인 인증 및 관련 서비스 제공
...
⑥ 유료 서비스 및 온라인 결제 서비스
- (필수)휴대폰번호, 컬쳐랜드/해피머니/북앤라이프 회원 아이디, 오픈마켓 아이디, 오픈마켓 닉네임
2) 고객상담
① 이용자 식별과 증빙자료 확인
- (필수)이메일주소
- (선택)ID, 이름, 닉네임, 캐릭터명, 회원번호, 휴대폰번호, 결제 휴대폰 정보, 마이핀번호, 신분을 확인할 수 있는 증서, 구글계정, Mac-Address, 생년월일, 성별, 주소, 전화번호, 연계정보(CI), 중복가입정보(DI), 이동통신사정보
3) 이벤트 및 서비스 마케팅
① 새로운 서비스 및 이벤트 정보의 안내
- (선택)휴대폰번호, 이메일주소
② 물품, 청구서, 경품 등의 배송
- (필수)이름, 휴대폰번호, 주소
③ 이벤트 당첨자의 제세공과금 부과
...
④ 이벤트 중복 참여 확인
- (선택)ADID/IDFA(광고식별자)
4) 서비스 이용에 따른 자동 수집 및 생성 정보
- 기기 정보, 이동통신사정보, IP, 접속기록, 서비스 이용 기록, 불량이용기록, 다운로드 기록, 대금결제 기록, 쿠키(cookie)
2. 개인정보의 보유 및 이용 기간
1) 회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 다음의 정보에 대해서는 ”보존 근거”에서 명시한 근거에 따라 “보존 기간”동안 보존합니다.
① 온라인/모바일 서비스 제공을 위해 수집한 정보
- 보존 근거 및 기간 : 회원, 게임 탈퇴 시 소비자의 불만 및 분쟁해결 등을 위한 목적으로 30일 보관
② 이벤트 및 서비스 마케팅을 위해 수집한 정보
- 보존 근거 및 기간 : 마케팅 정보 안내를 위한 목적으로 1년 보관 (정보 전송 이력은 전송일로부터 6개월간 보관할 수 있습니다.)
- 보존 근거 및 기간 : 이벤트 진행 관련 안내 및 당첨자 선정을 위해 최대 1년 보관 (이벤트 마다 상이할 수 있으며, 개별 이벤트 페이지에 기재된 기간을 우선합니다.)
2) 상법, 전자상거래 등에서의 소비자보호에 관한 법률 등 관계 법령의 규정에 의해 보존할 필요성이 있는 경우 회사는 관계 법령에서 정한 일정한 기간 동안 이용자의 개인정보를 보관할 수 있습니다. 이 경우 회사는 보관하는 정보를 그 보관의 목적으로만 이용합니다.
